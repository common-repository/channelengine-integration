 ...
 *
 * @package ChannelEngine\Infrastructure\Http
 */
class AsyncSocketHttpClient extends CurlHttpClient
{
     ...
     *
     * @throws \ChannelEngine\Infrastructure\Http\Exceptions\HttpRequestException Thrown when the request
