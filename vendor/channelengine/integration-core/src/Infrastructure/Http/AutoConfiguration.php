...
namespace ChannelEngine\Infrastructure\Http;
 ...
 *
 * @package ChannelEngine\Infrastructure\Http\Configuration
 */
class AutoConfiguration
{
     ...
     *
     * @param \ChannelEngine\Infrastructure\Configuration\Configuration $configService An instance of the configuration.
     * @param \ChannelEngine\Infrastructure\Http\HttpClient $httpClient An instance of the http client.
     */
     ...
     *
     * @throws \ChannelEngine\Infrastructure\Exceptions\BaseException <p>When configuration service did not implement
