...
use ChannelEngine\Infrastructure\TaskExecution\Events\BeforeQueueStatusChangeEvent;
...
class QueueService
{
    ...
    public function updateProgress(QueueItem $queueItem, $progress)
    {
        ...
        $this->save(
            ...
            $queueItem->getStatus() === QueueItem::COMPLETED,
            QueueItem::IN_PROGRESS
        );
    }
